package vn.edu.hcmuaf.fit.travelapp.activity;
...
import vn.edu.hcmuaf.fit.travelapp.adapter.CategoryAdapter;
import vn.edu.hcmuaf.fit.travelapp.adapter.PopularAdapter;
import vn.edu.hcmuaf.fit.travelapp.adapter.RecommendedAdapter;
import vn.edu.hcmuaf.fit.travelapp.adapter.SliderAdapter;
import vn.edu.hcmuaf.fit.travelapp.domain.Category;
import vn.edu.hcmuaf.fit.travelapp.domain.Item;
import vn.edu.hcmuaf.fit.travelapp.domain.Location;
import vn.edu.hcmuaf.fit.travelapp.R;
import vn.edu.hcmuaf.fit.travelapp.databinding.ActivityMainBinding;
import vn.edu.hcmuaf.fit.travelapp.domain.SliderItem;
