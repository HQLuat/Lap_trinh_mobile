package vn.edu.hcmuaf.fit.travelapp.payment.Constant;

public class AppInfo {
    public static final int APP_ID = 2553;
    public static final String MAC_KEY = "PcY4iZIKFCIdgZvA6ueMcMHHUbRLYjPL";
    public static final String REFUND_KEY      = "kLtgPl8HHhfvMuDHPwKfgfsY4Ydm9eIz"; // key2
    ...
    public static final String URL_QUERY_REFUND= "https://sb-openapi.zalopay.vn/v2/query_refund";
